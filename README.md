...
U projektu sam implementirala funkciju za pronalaženje svih mogućih načina deekscitacije iz zadanog pobuđenog stanja u osnovno stanje 
(rastavi broja na zbroj prirodnih brojeva), algoritam za izračun vjerojatnosti prijelaza između energijskih stanja u dva različita modela i
...
# KNIFE EDGE METHOD
Obradila sam podatke dobivene Knife-Edge metodom za određivanje veličine laserskog snopa. Izmjerene ovisnosti intenziteta o položaju oštrice normalizirala sam i aproksimirala funkcijom pogreške, čime sam odredila središte i promjer Gaussovog snopa te procijenila pripadnu mjernu nesigurnost. Rezultate sam prikazala grafički usporedbom eksperimentalnih podataka i dobivenog modela.
